...
<head>
	...
	<script async src="https://www.googletagmanager.com/gtag/js?id=UA-153657892-1"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
		function gtag() { dataLayer.push(arguments); }
		gtag('js', new Date());

		gtag('config', 'UA-153657892-1');
	</script>
		...
		<div class="contents">
			...
			<div id="table-area">
				<table id="all-champions" class="table table-bordered">
					<thead>
						<tr id="all-header">
							<th colspan="10">10.25 チャンピオン <span class="remain">あと○人</span></th>
						</tr>
					</thead>
					<tbody>
					</tbody>
